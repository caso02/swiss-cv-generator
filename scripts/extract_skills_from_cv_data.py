...
def main():
    ...
    try:
        ...
        console.print(f"[green]✅ Extracted {len(all_skills)} skills from {len(skills_by_job)} occupations[/green]")
        console.print()
        ...
        if unique_skills_de and OPENAI_AVAILABLE and settings.openai_api_key:
            ...
            console.print(f"[green]✅ Translated {len(translations)} skills[/green]")
            console.print()
        ...
        console.print(f"[green]✅ Inserted/updated {inserted_count} skills[/green]")
        console.print()
        ...
        console.print(f"[yellow]💰 Estimated AI Translation Cost: ~${estimated_cost:.2f}[/yellow]")
